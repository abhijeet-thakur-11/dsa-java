...
public class recursion {
    ...
    public static void removeduplicates(String str , int idx , boolean[] map , String nwstr){
        if(idx == str.length()){
            System.out.println(nwstr);
            return;
        }
    ...
    public static void subsequence(String str , int idx , String nwstr , HashSet<String> set){
       if(idx==str.length()){
